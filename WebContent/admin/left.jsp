  ...
  <tr>
    <td bgcolor="#F5EFE7">
            <table cellpadding=0 cellspacing=0 align=center width=200>    
            	<tr> 
            	<!-- admin 对应package 空间名称 listUsersAdminActionfangfa 是这个空间的* actin 中的方法。 ，但是空间没有指定 所以 -->
                <td height=20><a href=/netbank/admin/listUsersAdminActionfangfa?status.id=0 target=right>所有账户</a></td>
              </tr> 
              <tr> 
                <td height=20><a href=/netbank/admin/listUsersAdminActionfangfa?status.id=2 target=right>已冻结账户</a></td>
              </tr>
              <tr> 
                <td height=20><a href=/netbank/admin/listUsersAdminActionfangfa?status.id=1 target=right>已启用账户</a></td>
              </tr>
              <tr> 
